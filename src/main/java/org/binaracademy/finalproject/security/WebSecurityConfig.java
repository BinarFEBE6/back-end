...
//                    userService.processOAuthPostLogin(oauthUser.getEmail(), oauthUser.getName());
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://binar-academy-terbangin.herokuapp.com/","https://e-flight-development.netlify.app","http://localhost:3000","https://e-terbangin.vercel.app/"));
